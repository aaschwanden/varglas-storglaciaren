...
gdal_contour -inodata -fl -1999999999 $datadir/stor_${dem}.tif $datadir/$contour_file.shp
python scripts/shp2geo.py $datadir/$contour_file.shp $datadir/$contour_file.geo

# Create contour mesh
#gmsh $datadir/$contour_file.csv -1 -2
